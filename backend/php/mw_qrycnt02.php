...
//http://menswalk.prjlife.com/mw_qrycnt02.php?apikey=cat&id=C1_315081500H_000009&date=20200504
//============================
if (in_array($apikey, $arrAPIKEY)) { 
	doQueryCountById($aid, $qdate);
} else {
	echo "Invalid call.";
}
?>
...
function doQueryCountById($id, $qdate) {
	global $link;
...
WHERE A.id=?
	...
	$statement->bind_param('ss', $qdate, $id);
	$statement->execute();
